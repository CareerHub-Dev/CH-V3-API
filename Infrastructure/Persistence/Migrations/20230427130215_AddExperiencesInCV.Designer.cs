...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230427130215_AddExperiencesInCV")]
    partial class AddExperiencesInCV
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CV", b =>
                {
                    ...
                    b.Property<List<CVExperience>>("Experiences")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<string>>("HardSkills")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Domain.Entities.JobDirection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RecomendedTemplateLanguage")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.ToTable("JobDirections");
                });
            ...
            modelBuilder.Entity("Domain.Entities.JobPosition", b =>
                {
                    ...
                    b.Property<Guid>("JobDirectionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.JobPosition", b =>
                {
                    b.HasOne("Domain.Entities.JobDirection", "JobDirection")
                        .WithMany("Positions")
                        .HasForeignKey("JobDirectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("JobDirection");
                });
