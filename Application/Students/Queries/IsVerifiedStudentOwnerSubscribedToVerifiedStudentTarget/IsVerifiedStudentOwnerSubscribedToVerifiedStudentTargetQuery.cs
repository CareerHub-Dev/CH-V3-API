...
namespace Application.Students.Queries.IsVerifiedStudentOwnerSubscribedToVerifiedStudentTarget;

public record IsVerifiedStudentOwnerSubscribedToVerifiedStudentTargetQuery
    : IRequest<bool>
{
...
public class IsVerifiedActiveStudentOwnerSubscribedToVerifiedActiveStudentTargetQueryHandler
    : IRequestHandler<IsVerifiedStudentOwnerSubscribedToVerifiedStudentTargetQuery, bool>
{
    private readonly IApplicationDbContext _context;

    public IsVerifiedActiveStudentOwnerSubscribedToVerifiedActiveStudentTargetQueryHandler(
