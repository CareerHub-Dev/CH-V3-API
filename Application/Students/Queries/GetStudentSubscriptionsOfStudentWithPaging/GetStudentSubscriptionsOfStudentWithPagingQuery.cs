...
public record GetStudentSubscriptionsOfStudentWithPagingQuery
...
public class GetStudentSubscriptionsOfStudentWithPagingQueryHandler
    : IRequestHandler<GetStudentSubscriptionsOfStudentWithPagingQuery, PaginatedList<StudentDTO>>
{
    private readonly IApplicationDbContext _context;

    public GetStudentSubscriptionsOfStudentWithPagingQueryHandler(
    ...
    public async Task<PaginatedList<StudentDTO>> Handle(
        GetStudentSubscriptionsOfStudentWithPagingQuery request,
