...
public record GetFollowedShortStudentSubscriptionsOfStudentForFollowerStudentWithPagingQuery
...
public class GetFollowedShortStudentSubscriptionsOfStudentForFollowerStudentWithPagingQueryHandler
    : IRequestHandler<GetFollowedShortStudentSubscriptionsOfStudentForFollowerStudentWithPagingQuery, PaginatedList<FollowedShortStudentDTO>>
{
    private readonly IApplicationDbContext _context;

    public GetFollowedShortStudentSubscriptionsOfStudentForFollowerStudentWithPagingQueryHandler(
    ...
    public async Task<PaginatedList<FollowedShortStudentDTO>> Handle(
        GetFollowedShortStudentSubscriptionsOfStudentForFollowerStudentWithPagingQuery request,
