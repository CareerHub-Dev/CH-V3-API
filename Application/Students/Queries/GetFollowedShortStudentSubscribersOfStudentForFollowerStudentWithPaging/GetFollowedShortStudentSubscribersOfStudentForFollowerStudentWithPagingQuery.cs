...
public record GetFollowedShortStudentSubscribersOfStudentForFollowerStudentWithPagingQuery
...
public class GetFollowedShortStudentSubscribersOfStudentForFollowerStudentWithPagingQueryHandler
    : IRequestHandler<GetFollowedShortStudentSubscribersOfStudentForFollowerStudentWithPagingQuery, PaginatedList<FollowedShortStudentDTO>>
{
    private readonly IApplicationDbContext _context;

    public GetFollowedShortStudentSubscribersOfStudentForFollowerStudentWithPagingQueryHandler(
    ...
    public async Task<PaginatedList<FollowedShortStudentDTO>> Handle(
        GetFollowedShortStudentSubscribersOfStudentForFollowerStudentWithPagingQuery request,
