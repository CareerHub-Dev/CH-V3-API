...
public record GetFollowedShortStudentsForFollowerStudentWithPagingQuery
...
public class GetFollowedShortStudentsForFollowerStudentWithPagingQueryHandler
    : IRequestHandler<GetFollowedShortStudentsForFollowerStudentWithPagingQuery, PaginatedList<FollowedShortStudentDTO>>
{
    private readonly IApplicationDbContext _context;

    public GetFollowedShortStudentsForFollowerStudentWithPagingQueryHandler(
    ...
    public async Task<PaginatedList<FollowedShortStudentDTO>> Handle(
        GetFollowedShortStudentsForFollowerStudentWithPagingQuery request,
