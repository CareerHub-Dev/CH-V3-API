...
public record CreateCVWithoutPhotoCommand
    : IRequest<Guid>
{
...
public class CreateCVWithoutPhotoCommandHandler
    : IRequestHandler<CreateCVWithoutPhotoCommand, Guid>
{
    private readonly IApplicationDbContext _context;
    private readonly IImagesService _imagesService;

    public CreateCVWithoutPhotoCommandHandler(
    ...
    public async Task<Guid> Handle(
        CreateCVWithoutPhotoCommand request,
