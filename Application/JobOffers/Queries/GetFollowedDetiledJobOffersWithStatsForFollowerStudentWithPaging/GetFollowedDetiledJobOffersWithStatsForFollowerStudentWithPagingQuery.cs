...
public record GetFollowedDetiledJobOffersWithStatsForFollowerStudentWithPagingQuery
...
public class GetFollowedDetiledJobOffersWithStatsForFollowerStudentWithPagingQueryQueryHandler
    : IRequestHandler<GetFollowedDetiledJobOffersWithStatsForFollowerStudentWithPagingQuery, PaginatedList<FollowedDetiledJobOfferWithStatsDTO>>
{
    private readonly IApplicationDbContext _context;

    public GetFollowedDetiledJobOffersWithStatsForFollowerStudentWithPagingQueryQueryHandler(
    ...
    public async Task<PaginatedList<FollowedDetiledJobOfferWithStatsDTO>> Handle(
        GetFollowedDetiledJobOffersWithStatsForFollowerStudentWithPagingQuery request,
